...
<script type="text/javascript">
    ...
    $(document).ready(function() { 
        ...
        $("#okHapus").click(function() {  
            var i = $("#id").val();
            var url = "{{ URL::asset('staff/umroh/delete') }}/"+i;    
			...
			<div class="row-fluid">
				<div class="span12">	
					...
					<ul class="breadcrumb">
						...
						<li><a href="#">Manage Layanan Umroh</a></li>
					</ul>
                ...
                <table class="table table-striped" id="sample_3">
                    <thead>
                        <tr>
                            ...
                            <th class="hidden-phone" width='15%'>No. Telepon</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="hidden-phone">{{ $layanan->jamaah->alamat }}</td>
                            <td class="hidden-phone">{{ $layanan->no_spph }}</td>
                            <td class="hidden-phone">{{ $layanan->jamaah->no_telp }}</td>
                            <td class="hidden-phone">
                                <center>
                                    <a href="{{ URL::asset('staff/umroh/'.$layanan->idtransaksi.'/edit') }}" class="btn mini green icn-only editData"><i class="icon-check icon-white"></i> Edit</a>
                                    <a href="{{ URL::asset('staff/umroh/'.$layanan->idtransaksi) }}" class="btn mini yellow icn-only editData"><i class="icon-reorder icon-white"></i> Detail</a>
...
<div id="myModal1" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
    {{ Form::open(array('route' => 'staff.umroh.store', 'class' => 'form-horizontal')) }}
    <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>

	...
	<div class="page-content">
		<div class="container-fluid">
            ...
            <div class="portlet-body">
                {{ Form::open(array('url' => 'staff/passport-jamaah', 'files'=> 'true', 'class' => 'form-horizontal')) }}
                <input type="hidden" name="idpassport" value="{{ $data['idpassport'] }}">
                <table class="table table-striped" id="sample_3">
                    ...
                    <tbody>
                        ...
                        <tr>
                        	<td>
                                <input type="hidden" name="no_ktp[{{ $i }}]" value="{{ $jamaah->no_ktp }}">

...
<div class="page-container row-fluid">
	...
	<div class="container-fluid" style="background:#fff; min-height:800px">
		<!-- BEGIN PAGE HEADER-->
		<div class="row-fluid">
			<div class="span12">	
			...
			<div class="span4">
				<div class="tabbable tabbable-custom">
					<ul class="nav nav-tabs">
						...
						<li><a href="#tab_1_2" data-toggle="tab">Register</a></li>
					</ul>
							...
							<form action="#" class="form-vertical">
								<div class="control-group">
									<div class="controls">
										<div class="input-icon left">
											<i class="icon-envelope"></i>
											<input class="m-wrap large" type="text" placeholder="Email Address">    
										</div>
									</div>
								</div>
								<div class="control-group">

...
<table width=100%>
    <tr>
        ...
        <table class="laporan" width="100%">
            <tbody>
                ...
                <tr>
                    ...
                    <tr>
                        <td class="hidden-phone"><strong>Pergi Umroh</strong></td>
                        <td class="hidden-phone" colspan=3>
                            @foreach ( $data['generic'] as $wn )
                ...
                <tr><td class="hidden-phone"><strong>Paket Umroh</strong></td>
                    <td class="hidden-phone" colspan=3>
                        @foreach ( $data['generic'] as $wn )
                            @if ( $data['transaksi']->paket == $wn->id)
                            {{ $wn->desc }}
                            <?php break; ?>
                            @endif
                        @endforeach
                ...
                <tr><td class="hidden-phone"><strong>Kamar</strong></td>
                    <td class="hidden-phone" colspan=3>
                        @foreach ( $data['generic'] as $wn )
                            @if ( $data['transaksi']->kamar == $wn->id)
                            {{ $wn->desc }}
                            <?php break; ?>
                            @endif
                        @endforeach
        ...
        <table width=100%>
            <tr>
                <td ><img src="{{ public_path().'/images/user/'.$data['user']->jamaah->foto }}" width="150px"/></td>
                <td width="20%"></td>
                <td align="right">
                    <BR><BR><BR>
                    <center>

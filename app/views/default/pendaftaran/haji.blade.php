...
<div class="page-container row-fluid" style="background:#fff; min-height:800px">
	...
	<div class="container">
		...
		<div class="row-fluid">
			<div class="span8">
				{{ Form::open(array('url' => 'do-register-haji', 'files'=> 'true', 'class' => 'form-horizontal')) }}
				<h2>Formulir Pendaftaran Haji</h2>
				<div class="row-fluid">
					<div class="span12">
						...
						<div class="control-group">
							...
							<div class="controls">
								<select class="span12 m-wrap" tabindex="1" name="jeniskelamin" required>
						...
						<div class="control-group">
							...
							<div class="controls">
								<select class="span12 m-wrap" tabindex="1" name="kewarganegaraan" required> 
						...
						<div class="control-group">
							...
							<div class="controls">
								<select class="span12 m-wrap" tabindex="1" name="golongan-darah" required>
						...
						<h3 class="block-div">Pendaftaran Bimbingan Haji</h3>
						<div class="control-group">
							<label class="control-label">Pergi Haji</label>
								<div class="controls">
								<select class="span12 m-wrap" tabindex="1" name="pernah" required>
									<option SELECTED>-- Pilih Pergi Haji --</option>
						...
						<div class="control-group">
							...
							<div class="controls">
								<select class="span12 m-wrap" tabindex="1" name="hub-pendamping" required>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input class="m-span12 large" type="number" name="no_spph" placeholder="No. SPPH" required>
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							<label class="control-label">Bulan Keberangkatan</label>
								<div class="controls">
									<select id="status-jamaah" class="span12 m-wrap" tabindex="1" name="bulan" required>
						...
						<div class="control-group">
							...
							<div class="controls">
								<select id="status-jamaah" class="span12 m-wrap" tabindex="1" name="status-jamaah" required>
						...
						<div class="control-group">
							<label class="control-label">Scan SPPH</label>
							<div class="controls">
								<input type="file" name="imagespph" accept="image/gif, image/jpeg" id="i_file" required>
								<span class="label label-important">NOTE!</span>
								<span>Ukuran Foto Max 300 KB</span>
							</div>
						</div>
